// Spanish (default) locale dictionary
const es: Record<string, string> = {
  ...
  'sticky.tagline': 'Tu match deportivo, sin intermediarios',

  // Mobile nav aria
  'nav.open': 'Abrir menú',
  'nav.close': 'Cerrar menú',
  'nav.logo.aria': 'SportsMatch — Inicio',

  // Duality
  'duality.eyebrow': 'Dos caminos. Una plataforma.',
  'duality.title': 'Da igual de qué lado del campo estés.',
  'duality.sub': 'Cada perfil habla su idioma. Cada match empieza con un objetivo claro.',
  ...
  'stats.sub': 'Jugadores, clubes y profesionales que ya confían en SportsMatch para encontrar su próximo match.',
  'stats.users': 'Profesionales registrados',
  'stats.clubs': 'Clubes',
  'stats.matches': 'Publicaciones realizadas',
  'stats.sports': 'Deportes disponibles',
  ...
  'page.blog.desc': 'Noticias y artículos sobre deporte, clubes y jugadores.',
  'page.article.title': 'Artículo · SportsMatch',
